...
uses
  ...
  UTools, UFigures, UMove, LCLType, Types;
...
begin
  ...
  AdjustCanvasBounds(DoubleRect(ScrToWorldCrds(0,0),ScrToWorldCrds(PaintField.Width,PaintField.Height)));
...
begin
  HPos := round(ScrToWorldCrds(0,0).X);
  ...
  VPos := round(ScrToWorldCrds(0,0).Y);
